#!/usr/bin/python
#
# This is code derived work from GenerateTiles.py
# A stripped down version of that code to handle our single tile requests
...
class RenderThread:
    def __init__(self, tile_dir, mapfile, maxZoom, params):
        ...
        l = mapnik.LineSymbolizer(mapnik.Color(params.get('line')),1.0)
